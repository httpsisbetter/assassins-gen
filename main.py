...
def create_targets(names):
  ...
  for i in range(len(names)):
    ...
    while names[next_index] == current_name or names[
        next_index] in targets.values() or (names[next_index] in targets
                                            and targets[names[next_index]]
                                            == current_name):
